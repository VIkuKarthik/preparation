...
puts longest_consecutive([1,2,0,1]) # 3
puts longest_consecutive([0]) # 1
puts longest_consecutive([0,0]) # 1
puts longest_consecutive([0,-1])  # 2
puts longest_consecutive([4,0,-4,-2,2,5,2,0,-8,-8,-8,-8,-1,7,4,5,5,-4,6,6,-3])  # 5